...
import vulkan.Vertex.VertexInputStateInfo;
...
public class Pipeline {
    ...
    public Pipeline(PipelineCache pipelineCache, Pipeline.PipeLineCreationInfo pipeLineCreationInfo) {
        ...
        try (MemoryStack stack = MemoryStack.stackPush()) {
            ...
            VulkanShader.ShaderModule[] shaderModules = pipeLineCreationInfo.shaderProgram.getShaderModules();
    ...
    public record PipeLineCreationInfo(long vkRenderPass, VulkanShader shaderProgram, int numColorAttachments,
